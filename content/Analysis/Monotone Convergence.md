Let $f$ be a non-negative [[Analysis/Measurable Function]].
Let $(f_{n})$ be a sequence of such functions. 
Suppose that $f_{n}\uparrow f$. 
Then also [[Analysis/Integral]] $\mu(f_{n})\uparrow \mu(f)$.
...
### Proposition
Let $(g_{n})$ be a sequence of nonnegative [[Analysis/Measurable Function]]s.
Then:
$$

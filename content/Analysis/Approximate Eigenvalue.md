...
### Proposition
1. $\lambda$ is an [[XNotes/Eigenvalue]] of $T$ $\implies \lambda$ is an approximate eigenvalue
2. $\lambda$ is an approximate eigenvalue $\implies \lambda \in \sigma(T)$ [[XNotes/Spectrum]]

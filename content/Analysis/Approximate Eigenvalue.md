Let $X$ be a complex [[Analysis/Banach Space]], $T\in L(X)$ and $\lambda \in \mathbb{C}$
...
### Proposition
1. $\lambda$ is an [[Analysis/Eigenvalue]] of $T$ $\implies \lambda$ is an approximate eigenvalue
2. $\lambda$ is an approximate eigenvalue $\implies \lambda \in \sigma(T)$ [[Analysis/Spectrum]]

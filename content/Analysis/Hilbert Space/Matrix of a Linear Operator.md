Let $\mathcal{H}$ be a [[Analysis/Hilbert Space/Hilbert Space]] with an [[Analysis/Orthonormal Basis]] $(e_{n})$. 
For $T\in L(\mathcal{H})$ (a [[Analysis/Linear Operator]] $\mathcal{H}\to \mathcal{H}$) 

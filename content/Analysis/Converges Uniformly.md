...
### Theorem CTS
Suppose each $f_n$ is [[Topology/Continuous]] and $f_n\rightarrow f$ uniformly. 
Then $f$ is CTS.
#### Proof
...
Suppose $f_n\rightarrow f$ uniformly and each $f_n$ is [[Analysis/Riemann Integrable]]. 
Then $f$ is also [[Analysis/Riemann Integrable]] and $\int_a^bf_n\rightarrow \int_a^bf$.
#### Proof

...
So $T^{-1}$ also continuous by [[XNotes/Inversion Theorem]].

### Remarks
1. Comparability theorem gives a silly reason why $C[0,1]$ is incomplete in $\lVert  \rVert_{1}$
2. [[XNotes/Inversion Theorem]] tells us that if $X$, $Y$ [[Analysis/Banach Space]], $T\in C(X,Y)$ surjective then $X / Ker(T)$ is isomorphic to $Y$.

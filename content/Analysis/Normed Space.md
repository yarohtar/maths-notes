...
NOTE: a normed space gives rise to a [[Analysis/Metric space\|metric space]] with $d(x,y)=||x-y||$. So we can talk about open sets, closed sets, convergent sequences etc.

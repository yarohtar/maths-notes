...
Alternatively, $\mathcal{E}$ is a $\sigma$-algebra if it is a [[Analysis/Measure/pi-system]] and a [[Analysis/Measure/d-system]].
###### Remark
If you allow only finite unions in 3. then $\mathcal E$ is called an [[Analysis/Measure/Algebra]].
...
[[Analysis/Measure/Dynkin's pi-system Lemma]]
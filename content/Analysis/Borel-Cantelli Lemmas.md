...
If $\sum_{n}\mu(A_{n})<\infty$, then $\mu(\lim\sup A_{n})=0$ ([[XNotes/lim sup]])
#### Proof
As $n\to \infty$
$$
...
Assume that the events $(A_{n})$ are [[XNotes/Independence\|independent]]. 
If $\sum_{n}\mathbb{P}(A_{n})=\infty$ then $\mathbb{P}(\lim\sup A_{n})=1$. ([[XNotes/lim sup]])

...
### Theorem (altaltalt)
If $X$ is complete, then $X$ is not a [[Analysis/Meagre]] subset of $X$.

[[Analysis/Osgood's Theorem]]
[[Analysis/Principle of Uniform Boundedness]]
[[Analysis/Banach-Stewhaus Theorem]]
[[Analysis/Open Mapping Theorem]]

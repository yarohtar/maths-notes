...
4. If $p$ is a formula and $x$ is a [[Foundations/Free Variable]] in $p$ then $(\forall x)p$ is a formula

## Stuff
[[Foundations/Sentence]]
[[Foundations/Structure]]
[[Foundations/Interpretation]]
[[Foundations/Satisfied]]
[[Foundations/Theory]]
[[Foundations/Model (First-order Logic)]]
[[Foundations/Semantic Entailment (First-order logic)]]
[[Foundations/Tautology (First-order Logic)]]
[[Foundations/Syntactic Entailment (First-order Logic)]]
[[Foundations/Soundness Theorem (First-order Logic)]]
[[Foundations/Model Existence Lemma (First-order Logic)]]
[[Foundations/Adequacy Theorem (First-order Logic)]]
[[Foundations/Gödel's Completeness Theorem for First-Order Logic]]
[[Analysis/Compactness Theorem (First-order Logic)]]
[[Foundations/The Downward Löwenheim-Skolem Theorem]]
[[Foundations/The Upwards Löwenheim-Skolem Theorem]]
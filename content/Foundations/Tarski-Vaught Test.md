...
We only need to check formulas $\exists x\ \phi \in \Phi$ where $\phi$ is [[Foundations/Absolute]].
Note that this is already [[Foundations/Upwards Absolute]].
...
N\models \phi(m,m_{1},\dots,m_{n})
$$
By [[Foundations/Absolute]]ness of $\phi$, then also
$$

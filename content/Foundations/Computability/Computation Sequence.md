Given a [[Foundations/Computability/Register Machine\|register machine]] $M$ with upper register index $n$ and a [[Foundations/Computability/Configuration of a Register Machine]] $C$ of length $n+1$, we can define the action of $M$ on $C$. We say that $M$ transforms $C$ to $C'$.

A context-free formal language or a [[Foundations/Computability/The Chomsky Hierarchy#Type 2\|Type 2]] language 
...
there is a (not necessarily unique) [[Foundations/Computability/Parse Tree]] $T$ such that $\sigma_{T}=w$.

### Theorem
Every context free grammar $G$ 
has a [[Foundations/Computability/Chomsky Normal Form]] grammar $G'$ 
...
### Lemma
[[Foundations/Computability/Context-Free Pumping Lemma]]
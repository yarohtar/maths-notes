Let $F:\mathbb{B}^{n+1}\dashrightarrow \mathbb{B}^{n+1}$ be any [[Foundations/Computability/Partial Function]]. 
We say that a [[Foundations/Computability/Register Machine]] $M$ 

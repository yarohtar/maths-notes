...
# Axioms
In [[Foundations/Propositional Logic]] we adopt three axioms schemes
as axioms. They are all [[Foundations/Tautology (Propositional Logic)]]
## A1
$$
...
[[Foundations/Theorem (Propositional Logic)]]
[[Foundations/Deduction Theorem (Propositional Logic)]]
[[Foundations/Soundness Theorem (Propositional Logic)]]
[[Foundations/Model Existence Lemma (Propositional Logic)]]
[[Foundations/Adequacy Theorem (Propositional Logic)]]
[[Foundations/Completeness Theorem]]
Let $L$ be a [[Foundations/First-order predicate Logic]] language.
Let $S$ be a set of [[Foundations/Sentence]]s in $L$ and let $t$ be a [[Foundations/Sentence]] in $L$ 
We say $S$ semantically entails $t$ or $S\models t$ 
if $t$ is [[Foundations/Satisfied]] in every [[Foundations/Model (First-order Logic)]] of $S$.
...
let $u'$ be the [[Foundations/Sentence]] in the new language $L'$ 

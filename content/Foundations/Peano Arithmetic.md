...
Note that by [[Foundations/The Upwards Löwenheim-Skolem Theorem]] there is an uncountable model of PA.
...
[[Foundations/Gödel's Incompleteness Theorem]] implies that PA is not a complete theory. So there is a formula $p$ that holds in $\mathbb{N}_{0}$ but $PA\not\vdash p$

Suppose we are given [[Foundations/Functor\|functors]] $\mathcal{C}\xrightarrow{F,G}\mathcal{D}$
...
So for any two [[Foundations/Category\|categories]] $\mathcal{C}$ and $\mathcal{D}$ 
we have a [[Foundations/Category]] $[\mathcal{C},\mathcal{D}]$ of [[Foundations/Functor\|functors]] and natural transformations between them

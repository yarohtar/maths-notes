...
Let $C=\{ (B_{i},R_{i}):i\in I \}$ be a nonempty [[Foundations/Ordinals/Chain]] in $X$, i.e. a nested set of [[Foundations/Ordinals/Well-ordered]] sets. 
Then $\left( \bigcup B_{i},\bigcup R_{i} \right)$ is an [[Foundations/Ordinals/Upper Bound]] for $C$ 

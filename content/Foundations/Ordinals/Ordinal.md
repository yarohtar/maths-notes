...
### Proposition
Let $\alpha$ be an ordinal. Then the ordinals strictly less than $\alpha$ form a [[Foundations/Ordinals/Well-ordered]] set of [[Foundations/Set Theory/Order Type]] $\alpha$.
#### Proof

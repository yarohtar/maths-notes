Define, using [[Foundations/The Software Principle]], the sets:
$$
...
$$
### Theorem
The sets $K$ and $K_{0}$ are [[Foundations/Computably Enumerable]].
#### Proof
Just run them. If they halt, great. If not then output is $\uparrow$ which is fine.
### Theorem
The sets $K$ and $K_{0}$ are not [[Foundations/Computable]].
#### Proof

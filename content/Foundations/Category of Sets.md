...
Formally, morphisms are pairs $(f,B)$ where $f\subseteq A\times B$ is a [[Foundations/Function]]
(this is because codomain of $f$ is not uniquely defined in set theory)

See also [[Foundations/Category of Relations]] and [[Foundations/Category of Partial Functions]]
and note:
$$

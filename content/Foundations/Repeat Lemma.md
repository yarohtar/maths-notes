Let $W=\{ A_{0},A_{1} \}$ be a [[Foundations/Question]] about $n$-tuples with two answers
Let $F:\mathbb{B}^{n+1}\dashrightarrow \mathbb{B}^{n+1}$ a [[Foundations/Partial Function]]. 
Define by recursion 
- $F^{0}(\vec{w})=\vec{w}$

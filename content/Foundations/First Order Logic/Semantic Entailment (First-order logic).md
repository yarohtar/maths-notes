Let $L$ be a [[Foundations/First Order Logic/First-order predicate Logic]] language.
...
if $t$ is [[Foundations/First Order Logic/Satisfied]] in every [[Foundations/First Order Logic/Model (First-order Logic)]] of $S$.

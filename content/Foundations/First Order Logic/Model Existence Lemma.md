Let $S$ be a [[Foundations/Propositional Logic/Consistent]] [[Foundations/First Order Logic/Theory]] in a first-order [[Foundations/First Order Logic/Language]] $L=L\left( \Omega,\Pi \right)$
Then $S$ has a [[Foundations/First Order Logic/Model]].
#### Idea

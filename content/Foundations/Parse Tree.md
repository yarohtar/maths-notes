...
### Proposition
Let $G$ be a [[Foundations/Context-Free Formal Language\|context-free grammar]] which produces a word $w$. Then there exists a (not necessarily unique) parse tree $T$ such that $\sigma_{T}=w$.

In [[Foundations/Set Theory/Zermelo-Fraenkel Set Theory]] we can define the following
...
In turn, we can form the set $y^{x}$ of all [[Foundations/Set Theory/Function]] from $x$ to $y$:
$$

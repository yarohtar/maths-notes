Let $Y$ be a [[Foundations/Ordinals/Well-ordered]] set and $X\subseteq Y$
Then there is a unique [[Foundations/Ordinals/Initial Segment]] of $Y$ which is [[Foundations/Ordinals/Order-isomorphic]] to $X$ 
...
$$
for all $x\in X$
By [[Foundations/Ordinals/Proof by Induction]], $f$ is uniquely determined 
##### Existence
WLOG $Y\neq \emptyset$
Fix $y_{0}\in Y$
...
It will then follow that $im(f)$ is an [[Foundations/Ordinals/Initial Segment]] of $Y$ and we are done.

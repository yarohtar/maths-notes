A [[XNotes/Covering Spaces\|covering]] map $p:\tilde{X}\to X$ is a universal cover if $\tilde{X}$ is [[XNotes/Simply connected]].


### Theorem
Let $X$ be path connected (1), [[XNotes/Locally Path Connected]] (2), and [[XNotes/Semi-locally Simply Connected]] (3). Then there exists a covering $p:\tilde{X}\to X$ with $\tilde{X}$ simply connected.

...
### Lemma
Let $p$ be prime and $\mathbb{F}_{p}$ be a [[XNotes/Finite Field]]
...
#### Proof (sketch)
Needs [[XNotes/Galois Theory]] but basically, after adding one root to $\mathbb{F}_{p}$
...
(due to [[XNotes/A Freshman's Dream]])
(I THINK AT LEAST)

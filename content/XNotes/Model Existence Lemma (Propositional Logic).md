...
Then $S$ has a [[XNotes/Model (Propositional Logic)]]
## Proof
...
We show $T=\bigcup_{i\in I}T_{i}$ is an [[XNotes/Upper Bound]]: 
...
By [[XNotes/Zorn's Lemma]], $X$ has a maximal element $\bar{S}$

$S$ set, $R\subseteq F(S)$ where $F(S)$ is the [[XNotes/Free Group]]. 
...
$$
(Note that $\varphi$ above is the natural homomorphism induced by $\phi$ in [[XNotes/Free Group#Universal property of free groups]])

#### Proof
Suppose $\psi$, $\psi'$ give $\phi=\phi':S\to H$
By [[XNotes/Free Group#Universal property of free groups\|the universal property of free groups]] then also $\varphi=\varphi'$, so:
...
Find the induced $\varphi:F(G)\to G$ homomorphism by [[XNotes/Free Group#Universal property of free groups]].
Let $R=\mathrm{Ker}(\varphi)$. 
Then $\phi$ induces a homomorphism $\psi:\braket{ G | R }\to G$ which is an isomorphism by the [[XNotes/The isomorphism theorems (Groups)]] and noting that $\varphi$ was surjective. 

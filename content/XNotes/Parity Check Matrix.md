Let $C$ be a $(n,k)$ [[XNotes/Linear Code]]
A parity check matrix $H$ is a [[XNotes/Generator Matrix]] for $C^{\bot}$
...
### Lemma
Let $C$ be a [[XNotes/Linear Code]] with parity check matrix $H$.

Let $E$ be a set with a [[XNotes/sigma-algebra]] $\mathcal{E}$ on it
...
- If $\mu(E)=1$ then $\mu$ is a probability measure 
  and $(E,\mathcal{E},\mu)$ is a [[XNotes/Probability Space]], often denoted  by $(\Omega,\mathcal{F},\mathbb{P})$
...
[[XNotes/Uniqueness of Measures]]
[[Analysis/Borel Sigma Algebra]]
[[XNotes/Lebesgue Measure]]
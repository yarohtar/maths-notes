Let $p:\tilde{X}\to X$ be a [[XNotes/Covering Spaces\|covering map]], 
Let $H:Y\times I\to X$ be a homotopy from $f_{0}$ to $f_{1}$
Let $\tilde{f}_{0}$ be a [[XNotes/Lift]] of $f_{0}$
...
Fix $y_{0}\in Y$.
By [[XNotes/Lebesgue number lemma]] applied to $\{ y_{0} \}\times I$, 
...
By [[XNotes/Uniqueness of Lifts Lemma]], they must agree on an open and closed subset of $(W_{y_{0}}\cap W_{y_{1}})\times I$.
...
### Corollaries
[[XNotes/Path Lifting Lemma]]
[[XNotes/Path Push Forward Bijection Proposition]]

[[XNotes/Covering Fundamental groups]]

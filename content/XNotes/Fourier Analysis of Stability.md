...
Let $\hat{u}^n(\theta)=\sum_{m}e^{-im\theta}u_{m}^n$ for all $n$ (by using [[XNotes/Fourier Transform#Sequences]])
...
In particular, using [[XNotes/Parseval's Identity]]:
$$
...
Then the [[XNotes/Fourier Transform]] is given by:
$$

...
Thus by [[XNotes/The Baire Category Theorem]], some $\overline{T(n,B_{x})}$ contains a ball $B(y,\epsilon)$.
...
Thus $T$ any open mapping by [[XNotes/Open Mapping Lemma]] applied to $\frac{T}{\epsilon}$.

### Corollaries
[[XNotes/Inversion Theorem]]

...
Hence if $\phi$ is convex, we are sure to have $\lambda$ in [[XNotes/Lagrange sufficiency theorem]].

### Proof
Suppose $\phi$ is convex. Then find [[XNotes/Supporting hyperplane]] $\lambda$ of $\phi$ at $b$ and write:
$$\begin{align*}

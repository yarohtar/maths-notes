[[XNotes/Forms of linear programs]]
## Solving the linear program

[[XNotes/Maximum of convex function]] is always at an [[XNotes/Extreme point of convex set\|extreme point]] (of domain).
...
This is too slow! 
We can improve if we had a condition which guarantees us that we already found the minimum (like in [[XNotes/First-order condition#Minimum\|convex function minimum]]). 

The information rate $H$ of a [[XNotes/Source]] is the infimum of all rates at which it is [[XNotes/Reliably encodable]]
### Lemma
The [[XNotes/Source Information Rate]] of a [[Information Theory/Bernoulli Source]] is at most the expected word length of an [[XNotes/Optimal Code]].
#### Proof
...
\end{align}
$$
by [[XNotes/Weak Law of Large Numbers]].
...
$$
So the source is [[XNotes/Reliably encodable]] at rate $r=\mathbb{E}(S_{1})+\epsilon$ for all $\epsilon>0$. 
Hence the information rate is at most $\mathbb{E}(s_{1})$.
### Corollary
A Bernoulli source has information rate less than $H(X)+1$.
#### Proof
[[XNotes/Shannon's noiseless coding theorem]]
### Proposition

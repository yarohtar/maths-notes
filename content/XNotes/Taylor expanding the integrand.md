...
\end{align}
$$
where $\phi_{n}=x^n$ is an [[Asymptotic Methods/Asymptotic Sequence]] as $x\to 0$
...
This clearly doesn't converge for any $x>0$, but if we [[XNotes/Optimal Truncation\|truncate]] it, we should get a really good approximation.

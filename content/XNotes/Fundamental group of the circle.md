...
$$
#### Proof
Take the [[XNotes/Covering Spaces\|covering map]] $p:\mathbb{R}\to S^1$ with $p(t)=e^{2\pi it}$.

$p ^{-1}(1)=\mathbb{Z}\subseteq \mathbb{R}$.
Basepoint $\tilde{x}_{0}=0\in p ^{-1}(1)$. 
This determines a [[XNotes/Covering Fundamental groups#Corollary\|bijection]] $l:\pi_{1}(S^1,1)\to \mathbb{Z}$.
...
### Corollary
[[XNotes/Fundamental Theorem of Algebra]]
...
Suppose $r:D^2\to S^1$ is a [[XNotes/Retraction map\|retraction]], $r\circ i=id_{S^1}$
...
### Corollary
[[XNotes/Browen's Fixed Point Theorem]]

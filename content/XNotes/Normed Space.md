Let $X$ be a real or complex vector space with [[XNotes/Norm]] $\lVert \cdot \rVert$
A normed space is a pair $(X,||\cdot||)$

NOTE: a normed space gives rise to a [[XNotes/Metric spaces\|metric space]] with $d(x,y)=||x-y||$. So we can talk about open sets, closed sets, convergent sequences etc.

[[XNotes/L norms]]
[[Analysis/Banach Space]]
[[XNotes/Metric spaces#Some properties]]
[[XNotes/Unit Ball]]

[[XNotes/Separable Space]]

[[XNotes/Equivalent Norms]]

[[XNotes/Open Mapping Lemma]]

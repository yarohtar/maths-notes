A nontrivial [[XNotes/Index Set]] cannot be computable.
### Proof
...
(We used $K$ from [[XNotes/The Halting Problem]])

By [[XNotes/The s-m-n Theorem]] we get a computable function $h_{w}$ 
such that 
$$

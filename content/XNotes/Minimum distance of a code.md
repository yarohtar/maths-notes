The minimum distance of a [[Information Theory/Binary Code]] $C$ is the smallest [[XNotes/Hamming distance]] between distinct codewords.
...
1. Then $C$ is $(d-1)$-[[XNotes/Error detecting]], but cannot detect $d$ errors
2. $C$ is $\left\lfloor  \frac{d-1}{2}  \right\rfloor$-[[XNotes/Error correcting]], but cannot correct all sets of $\left\lfloor  \frac{d-1}{2}  \right\rfloor+1$ errors
#### Proof

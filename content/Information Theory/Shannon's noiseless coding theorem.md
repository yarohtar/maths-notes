[[Information Theory/Expected word length]] for an [[Information Theory/Optimal Code]] $f$ satisfies:
$$
\frac{H(X)}{\log a}\leq E(S)<\frac{H(X)}{\log a}+1
$$
where $a=\lvert \Sigma_{2} \rvert$, and $H(X)$ is the  [[Information Theory/Mathematical Entropy]].
...
$$
So by [[Information Theory/McMillan's Theorem]] there is a prefix-free code with word lengths $s_{1},\dots,s_{m}$
Also
$$
\begin{align}

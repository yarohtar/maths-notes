Let $C$ be a $(n,k)$ [[Information Theory/Linear Code]]
A parity check matrix $H$ is a [[Information Theory/Generator Matrix]] for $C^{\bot}$
...
### Lemma
Let $C$ be a [[Information Theory/Linear Code]] with parity check matrix $H$.

Let $K$ be some [[XNotes/Finite Field]] extension of $\mathbb{F}_{2}$ and $n$ odd
...
$$
Note that as the [[XNotes/Generator Polynomial]] $g(X)$ of $C$ divides $X^{n}-1$, 
...
We also find that [[XNotes/Splitting Field]] of $X^{7}-1$ is $\mathbb{F}_{8}\simeq \mathbb{F}_{2} /(X^{3}+X+1)$

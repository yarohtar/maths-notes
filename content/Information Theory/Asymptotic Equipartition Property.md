A [[XNotes/Source]] $X_{1},X_{2},\dots$ satisfies the Asymptotic Equipartition Property (AEP) with constant $H\geq 0$ if 
For all $\epsilon>0$ 
...
### Definition 2
A [[XNotes/Source]] $X_{1},X_{2},\dots$ satisfies AEP if for some $H\geq 0$
$$
...
This second definition comes from [[XNotes/Shannon's 1st coding theorem]]

### Proposition
A [[Information Theory/Bernoulli Source]] satisfies AEP with information rate $H(X)$ for $H(X)$ [[XNotes/Mathematical Entropy]].

Given a [[Information Theory/Cryptosystem]] $\mathcal{M}$, $\mathcal{E}$, $\mathcal{K}$, with functions $e$ and $d$.
...
Both [[Information Theory/Substitution cipher]] and [[Information Theory/Vigenere Cipher]] 

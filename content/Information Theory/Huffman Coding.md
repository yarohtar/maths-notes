...
Let $f$ be an [[Information Theory/Optimal Code]], prefix free, with word lengths $s_{1},\dots ,s_{m}$
...
$m>2:$ [[Information Theory/Source]] $X_{m}$ emits $\mu_{1},\dots,\mu_{m}$ with probabilities $p_{1}\geq\dots\geq p_{m}$

...
Hence, this is a [[Numerical/Linear Program]]:
...
Then there is a first integral of [[Calculus/Euler-Lagrange]] equations:
...
Then for any $0<r<R$ the series [[Analysis/Uniform convergence of functions\|converges uniformly]] on $D(a,r)$.
#### Proof sketch
Take $w$ s.t. $r<|w-a|<R$, 
...
We are done by [[Analysis/Uniform Cauchy]].

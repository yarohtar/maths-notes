...
Then using [[XNotes/Lagrange Cardinal Polynomials]] we find:
...
Pick $c_k$ to be roots of $p_n$ where $p_n$ is the $n$th [[XNotes/Orthogonal polynomials]] for this weight function, and $b_k=L(l_k)$.

...
Hence if $\phi$ is convex, we are sure to have $\lambda$ in [[Numerical/Lagrange sufficiency theorem]].

### Proof
Suppose $\phi$ is convex. Then find [[Analysis/Supporting hyperplane]] $\lambda$ of $\phi$ at $b$ and write:
$$\begin{align*}

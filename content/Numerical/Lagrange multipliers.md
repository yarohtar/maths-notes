...
The following method works as long as we have [[Numerical/The Necessity Theorem]].
...
$$
3. Find the set of [[Numerical/Feasible Lagrange Multipliers]]
$$
...
Now apply [[Numerical/Lagrange sufficiency theorem]] to this.
...
That is a feasible solution so by [[Numerical/Lagrange sufficiency theorem]] we are done.

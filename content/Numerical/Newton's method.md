...
Take gradient and set to zero [[Analysis/First-order condition#Minimum]]
$$
...
### Theorem:
Let $f$ be an [[Analysis/Alpha-strongly convex]] function. 
Let $\nabla^2f(x)$ be $l$-[[Analysis/Lipschitz]]. 

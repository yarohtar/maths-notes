...
Also in an optimal strategy $w=v$ (by [[Numerical/Duality (Optimisation)#Strong duality\|strong duality]]). Hence, using [[Numerical/Optimality conditions in LPs\|optimality conditions]] we arrive at the following theorem:
## Theorem

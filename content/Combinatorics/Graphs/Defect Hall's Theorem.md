...
$$
After finding the [[Combinatorics/Graphs/Matching]], remove the vertices $z_{1},\dots,z_{d}$
Because of injectivity, we get a [[Combinatorics/Graphs/Matching with Deficiency]] at most $d$

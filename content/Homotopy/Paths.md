...
Paths $\gamma:x_{0}\leadsto x_{1}$ and $\gamma':x_{0}\leadsto x_{1}$ are homotopic as paths from $x_{0}$ to $x_{1}$ if they are homotopic as [[Homotopy/Homotopy#Definition (homotopy)\|maps]] relative to $\{ 0,1 \}$

[[Homotopy/Path Components]]

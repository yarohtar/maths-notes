...
### Proposition
Suppose that $X$ is path-connected, [[Analysis/Locally Path Connected]], and [[Topology/Semi-locally Simply Connected]].
...
#### Proof
Let $q:\bar{X}\to X$ be the [[Homotopy/Universal Cover]] that we constructed, whose underlying set is the set of homotopy classes of paths in $X$ starting at $x_{0}$.

A [[Homotopy/Covering Spaces\|covering]] map $p:\tilde{X}\to X$ is a universal cover if $\tilde{X}$ is [[Topology/Simply connected]].


### Theorem
Let $X$ be path connected (1), [[Analysis/Locally Path Connected]] (2), and [[Topology/Semi-locally Simply Connected]] (3). Then there exists a covering $p:\tilde{X}\to X$ with $\tilde{X}$ simply connected.

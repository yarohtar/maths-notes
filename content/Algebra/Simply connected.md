$X$ is simply connected if it is [[Homotopy/Path Components\|path connected]] and its [[Homotopy/Fundamental group\|fundamental group]] is trivial in some (hence all) basepoints.

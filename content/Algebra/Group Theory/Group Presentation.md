$S$ set, $R\subseteq F(S)$ where $F(S)$ is the [[Algebra/Group Theory/Free Group]]. 
...
$$
(Note that $\varphi$ above is the natural homomorphism induced by $\phi$ in [[Algebra/Group Theory/Free Group#Universal property of free groups]])

#### Proof
Suppose $\psi$, $\psi'$ give $\phi=\phi':S\to H$
By [[Algebra/Group Theory/Free Group#Universal property of free groups\|the universal property of free groups]] then also $\varphi=\varphi'$, so:
...
Find the induced $\varphi:F(G)\to G$ homomorphism by [[Algebra/Group Theory/Free Group#Universal property of free groups]].

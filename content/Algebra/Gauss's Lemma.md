Let $R$ be a [[Algebra/Unique Factorisation Domain]] with a field of fractions $F$. Suppose $f\in R[X]$ is primitive and irreducible in $R[X]$. Then $f$ is irreducible in $F[X]$.
### Lemma

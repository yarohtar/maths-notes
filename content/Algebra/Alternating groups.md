### Ccls
Every [[Algebra/Group actions#Action on itself\|conjugacy class]] in $A_n$ is either the same as in $S_n$ or it splits into two. Moreover, $ccl_{A_n}(\sigma)$ splits if and only if the [[Algebra/Permutation groups#Cycle type\|cycle type]] of $\sigma$ has distinct odd numbers.
#### Proof

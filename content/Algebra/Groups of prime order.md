...
### Theorem (centre)
If $G$ is a $p$-group, then the [[Algebra/Group actions#Action on itself\|centre]] $Z(G)$ is nontrivial.
#### Proof
...
##### Proof
In the [[Algebra/Simple groups#Decomposition\|decomposition]] of $G$ we have:

...
Let $\mathcal{A}$ be a [[Combinatorics/Combinatorial Structure\|Structure]] with $a_{0}=0$ 
and $\mathcal{B}$ a [[Combinatorics/Combinatorial Structure\|Structure]] with $b_{0}=1$.

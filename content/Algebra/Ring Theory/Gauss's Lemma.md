Let $R$ be a [[Algebra/Ring Theory/Unique Factorisation Domain]] with a [[Algebra/Ring Theory/Field of Fractions]] $F$. 
...
If $g\mid f$ in $F[X]$, then $g\mid f$ in $R[X]$, where $F$ is the [[Algebra/Ring Theory/Field of Fractions]] of $R$. 

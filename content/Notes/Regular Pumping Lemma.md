...
### Theorem
For every [[Notes/Regular Formal Language]] $L$, there is a number $n$ st $L$ satisfies regular pumping lemma with pumping number $n$.
#### Proof
$L$ is generated by some [[Notes/Deterministic Automata]] $D=(\Sigma,Q,\delta,q_{0},F)$.

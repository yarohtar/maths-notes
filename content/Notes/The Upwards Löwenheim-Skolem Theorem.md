...
By [[Notes/Compactness Theorem (First-order Logic)]] $S'$ has a model $A$, i.e. a model $A$ of $S$ together with an injection $I\to A$ $c_{i}\to(c_{i})_{A}$

### Note
For any set $X$, can take $I=\gamma(X)$ [[Notes/Hartogs' Lemma]]

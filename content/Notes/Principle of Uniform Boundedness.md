$X$ [[Notes/Banach Space]], $Y$ [[Notes/Normed Space]].
...
So by [[Notes/The Baire Category Theorem]] we have $B(X,\epsilon)\subseteq E_{n}$ for some $n$, some $x\in X$, some $\epsilon>0$.

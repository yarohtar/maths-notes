Let $f$ be a non-negative [[Notes/Measurable Function]].
Let $(f_{n})$ be a sequence of such functions. 
Suppose that $f_{n}\uparrow f$. 
Then also [[Notes/Integral]] $\mu(f_{n})\uparrow \mu(f)$.
...
### Proposition
Let $(g_{n})$ be a sequence of nonnegative [[Notes/Measurable Function]]s.
Then:
$$

...
### Definition
Suppose we have an [[Notes/Asymptotic Approximation]] which holds for all $N$. Then we have an asymptotic series and we write:
$$
...
We divide $\mathbb{C}$ into special sectors in which different [[Notes/Asymptotic Approximation\|asymptotic approximations]] hold. Their boundaries are called Stokes lines 

For $X$ [[Notes/Normed Space]], $N$ a closed subspace of $X$, have Quotient vector space $X / N$ with projection map $\pi$.
...
$X$ is [[Notes/Banach Space]] $\implies$ $X /N$ is Banach.
...
Done by [[Notes/Open Mapping Lemma]]

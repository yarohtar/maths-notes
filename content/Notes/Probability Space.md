A probability space  $(\Omega,\mathcal{F},\mathbb{P})$ (i.e. a [[Notes/Measure\|measure space]] with $\mathbb{P}(\Omega)=1$) 
...
In addition to [[Notes/Measure\|measure theory]], 
probability theory also has the notion of [[Notes/Independence]].

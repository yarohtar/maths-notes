...
### Proposition
Suppose that $X$ is path-connected, [[Notes/Locally Path Connected]], and [[Notes/Semi-locally Simply Connected]].
...
#### Proof
Let $q:\bar{X}\to X$ be the [[Notes/Universal Cover]] that we constructed, whose underlying set is the set of homotopy classes of paths in $X$ starting at $x_{0}$.

...
[[Notes/Feedback Shift Register]] $f:\mathbb{F}_{2}^{d}\to \mathbb{F}_{2}^{d}$ with $C$ linear i.e. 
$$
...
with auxiliary polynomial $P$ if and only if its [[Notes/Generating Function]] 

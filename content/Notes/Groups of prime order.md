...
### Theorem (centre)
If $G$ is a $p$-group, then the [[Notes/Group actions#Action on itself\|centre]] $Z(G)$ is nontrivial.
#### Proof
...
##### Proof
In the [[Notes/Simple groups#Decomposition\|decomposition]] of $G$ we have:

...
This function is in the class of [[Notes/Gödel's primitive recursive functions]] so it is [[Notes/Computable]]. 

So the map $(v,w)\to u$ if $\#u=z(\#v,\#w)$ is a computable function.
We write $v*w=u$ and call this operation merging.

The inverse of this operation is also [[Notes/Computable]] and we call this splitting:
$$

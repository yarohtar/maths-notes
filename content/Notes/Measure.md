Let $E$ be a set with a [[Notes/sigma-algebra]] $\mathcal{E}$ on it
...
- If $\mu(E)=1$ then $\mu$ is a probability measure 
  and $(E,\mathcal{E},\mu)$ is a [[Notes/Probability Space]], often denoted  by $(\Omega,\mathcal{F},\mathbb{P})$
...
[[Notes/Ring (of sets)]]
[[Notes/Carathéodory's Extension Theorem]]
[[Notes/Uniqueness of Measures]]
[[Notes/Borel Sigma Algebra]]
[[Notes/Lebesgue Measure]]
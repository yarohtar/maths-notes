...
Suppose we have a [[Notes/Numerical methods for ODEs]] with some step size $h$. We define the linear stability domain:
...
Using the [[Notes/Maximum principle]], we find that it is enough to check

...
So $T^{-1}$ also continuous by [[Notes/Inversion Theorem]].

### Remarks
1. Comparability theorem gives a silly reason why $C[0,1]$ is incomplete in $\lVert  \rVert_{1}$
2. [[Notes/Inversion Theorem]] tells us that if $X$, $Y$ [[Notes/Banach Space]], $T\in C(X,Y)$ surjective then $X / Ker(T)$ is isomorphic to $Y$.

...
Take gradient and set to zero [[Notes/First-order condition#Minimum]]
...
### Theorem:
Let $f$ be an [[Notes/Alpha-strongly convex]] function. Let $\nabla^2f(x)$ be [[Notes/l-lipshitz]]. then Newton's method satisfies the bound:

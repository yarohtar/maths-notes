...
[[Notes/Computation Sequence]]
[[Notes/Strong Equivalence of Register Machines]]
[[Notes/Partial Function]]
[[Notes/Question]]
## Standard operations
[[Notes/Subroutine Lemma]]
[[Notes/Case Distinction Lemma]]
[[Notes/Repeat Lemma]]

## Computability
[[Notes/Computable]]
[[Notes/Computably Enumerable]]

## Operations on natural numbers
[[Notes/Encoding Numbers in Binary Words]]
[[Notes/Truncation of Register Machine]]
[[Notes/Gödel's primitive recursive functions]]
[[Notes/Partial Recursive Functions]]
[[Notes/Splitting and Merging Words]]

## Coding Langauges
[[Notes/Encoding Alphabets in Binary Words]]
[[Notes/Encoding Register Machines]]
[[Notes/The Software Principle]]
[[Notes/The s-m-n Theorem]]
[[Notes/Kleene's Recursion Theorem]]

## Misc
[[Notes/Computability Hierarchy]]
[[Notes/Reduction Function]]
[[Notes/Turing Joint]]
[[Notes/Complete Language]]
[[Notes/Index Set]]

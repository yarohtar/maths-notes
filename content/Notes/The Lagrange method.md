OLD VERSION
SEE [[Notes/Lagrange multipliers]]


We want to minimize $f(x)$ s.t. $h(x)=b$ and $x\in X$

## The theorem
[[Notes/Lagrange sufficiency theorem]]
...
#
[[Notes/Complimentary slackness]]

[[Notes/When does Lagrange method work]]

[[Notes/Economist perspective]]

...
### Corollary
$f$ is differentiable at $z_0$ iff partial derivatives of $u$ and $v$ exist and are continuous around $z_0$ and they satisfy the Cauchy-Riemann equations. Proved in [[Notes/Analysis and Topology]].
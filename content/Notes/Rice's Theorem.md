A nontrivial [[Notes/Index Set]] cannot be computable.
### Proof
...
(We used $K$ from [[Notes/The Halting Problem]])

By [[Notes/The s-m-n Theorem]] we get a computable function $h_{w}$ 
such that 
$$

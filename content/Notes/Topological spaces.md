...
1. Some topologies are induced by a [[Notes/Metric spaces\|metric]].
2. [[Notes/Hausdorff space]]
3. $A\subset X$ is open if every point has an open [[Notes/Neighbourhood\|nbd]] that is contained in $A$
4. $x_n\to x$ if for any nbd $V$ of $x$ we find $N$ s.t. $x_n\in V$ for $n>N$
5. In a [[Notes/Hausdorff space]], the limits are unique.
...
8. [[Notes/Accumulation points]]
9. [[Notes/Interior and closure]]
10. [[Notes/Subspace topology]]
11. [[Notes/Continuity in topological spaces]]
12. $X$ and $Y$ are [[Notes/Homeomorphism\|homeomorphic]] if there is a bijection $f$ between them such that both $f$ and $f^{-1}$ are continuous
13. [[Notes/Product topology]]
14. [[Notes/Open map]]
15. [[Notes/Quotient space]]

## More stuff
[[Notes/Connectedness]]
[[Notes/Compactness]]
[[Notes/Sequential compactness]]
...
$$
#### Proof
Take the [[Notes/Covering Spaces\|covering map]] $p:\mathbb{R}\to S^1$ with $p(t)=e^{2\pi it}$.

$p ^{-1}(1)=\mathbb{Z}\subseteq \mathbb{R}$.
Basepoint $\tilde{x}_{0}=0\in p ^{-1}(1)$. 
This determines a [[Notes/Covering Fundamental groups#Corollary\|bijection]] $l:\pi_{1}(S^1,1)\to \mathbb{Z}$.
...
### Corollary
[[Notes/Fundamental Theorem of Algebra]]
...
Suppose $r:D^2\to S^1$ is a [[Notes/Retraction map\|retraction]], $r\circ i=id_{S^1}$
...
### Corollary
[[Notes/Browen's Fixed Point Theorem]]

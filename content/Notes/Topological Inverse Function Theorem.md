...
Fix any closed $V\subseteq X$. Then $V$ is compact since $X$ is compact. Then the image $f(V)$ is compact, but then $f(V)$ is closed (by [[Notes/Compact-closed]]), hence we are done.
...
$$
After finding the [[Notes/Matching]], remove the vertices $z_{1},\dots,z_{d}$
Because of injectivity, we get a [[Notes/Matching with Deficiency]] at most $d$

...
1. [[Notes/Consistency of Numerical Methods\|Consistent]]
2. [[Notes/Stability of Numerical Methods\|Stable]]
#### Proof ($\implies$)
...
$$
we get that the method is [[Notes/Stability of Numerical Methods\|stable]] iff
$$
\lVert A_{h} \rVert \leq 1 \text{ as } h\to 0
$$
Suppose the method is also [[Notes/Consistency of Numerical Methods\|consistent]]. 

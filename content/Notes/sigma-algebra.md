...
Alternatively, $\mathcal{E}$ is a $\sigma$-algebra if it is a [[Notes/pi-system]] and a [[Notes/d-system]].
###### Remark
If you allow only finite unions in 3. then $\mathcal E$ is called an [[Notes/Algebra (of sets)]].
...
[[Notes/Dynkin's pi-system Lemma]]
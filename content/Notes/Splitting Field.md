...
### Lemma
Let $p$ be prime and $\mathbb{F}_{p}$ be a [[Notes/Finite Field]]
...
#### Proof (sketch)
Needs [[Notes/Galois Theory]] but basically, after adding one root to $\mathbb{F}_{p}$
...
(due to [[Notes/A Freshman's Dream]])
(I THINK AT LEAST)

MORAL: [[Notes/Banach Space]]s are very nice

### Theorem
Let $X$ be a (nonempty) [[Notes/Banach Space]] space, and $O_{1},O_{2}\dots$ a sequence of dense open sets. Then: 
$$
...
### Theorem (altaltalt)
If $X$ is complete, then $X$ is not a [[Notes/Meagre]] subset of $X$.

[[Notes/Osgood's Theorem]]
[[Notes/Principle of Uniform Boundedness]]
[[Notes/Banach-Stewhaus Theorem]]
[[Notes/Open Mapping Theorem]]
[[Notes/Continuous, Nowhere Differentiable Functions]]
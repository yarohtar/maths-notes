...
### Strong duality
We can restate the [[Notes/Lagrange sufficiency theorem]]: If $x^*$ and $\lambda^*$ are feasible for primal and dual problem respectively, and $h(x^*)=f(x^*)$ then $x^*$ is optimal.

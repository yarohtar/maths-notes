[[Notes/Strong duality in linear programs]]
...
[[Notes/Complimentary slackness]] means that
$$(c^T-\lambda^TA)x=0$$
...
we can find such $\lambda$ and hence use [[Notes/Optimality conditions in LPs#Theorem\|the theorem]] to finish.
...
## Full discretization
Similar as in [[Notes/Numerical Methods for Poisson Equation]]
...
$$
#### Proof 2
Apply [[Notes/Lax Equivalence Theorem]].

### Theorem
This method is [[Notes/Stability of Numerical Methods\|stable]] for $l_{2}$ [[Notes/L norms\|norm]] iff $\mu\leq \frac{1}{2}$.
#### Proof
Look at eigenvalues of $A_{h}=I+\mu A_{*}$ 
noting that $A_{*}$ is a [[Notes/TST matrix]] with $\alpha=-2$, $\beta=1$
...
where $A_{*}$ is a [[Notes/TST matrix]] with $\alpha=-2$, $\beta=1$
Let $A=B^{-1}C$.
Amazingly, $B$ and $C$ have the same set of eigenvectors, 
hence $A$ also does and they are all [[Notes/Normal Matrix]]

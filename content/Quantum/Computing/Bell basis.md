Let $C$ be a [[Quantum/Computing/Circuit]] which is equivalent to $CNOT\circ H\otimes I$
...
We can also generate all the Bell states from $\ket{\phi^{+}}$ using [[Quantum/Pauli Matrices]]:
$$
\ket{\phi^{-}} = Z \ket{\phi^{+}}
$$
$$

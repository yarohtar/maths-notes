...
$$
Call $N=A^{\dagger}A$ the ([[Analysis/Hilbert Space/Hermetian\|Hermetian]]) number operator.
We now have operators but we don't have the [[Analysis/Hilbert Space/Hilbert Space\|Hilbert space]].

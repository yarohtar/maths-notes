# General definition
Let $\mathcal{H}$ be a [[Analysis/Hilbert Space]]. 
...
(i.e. they are [[Analysis/Hermetian]] and $M_{n}M_{m}=\delta_{mn}M_{n}$).
Now any [[Analysis/Hermetian]] operator $M$ can be represented as 
$$
...
- Any observable $O$ has associated [[Analysis/Hermetian]] operator $\hat O$.

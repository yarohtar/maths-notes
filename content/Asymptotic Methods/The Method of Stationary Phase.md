Consider the [[Asymptotic Methods/Oscillatory Integrals]]:
$$
...
By [[Asymptotic Methods/Oscillatory Integrals with monotonic phase]], 
...
$$
which we solve using [[Calculus/The Fresnel Integrals]].

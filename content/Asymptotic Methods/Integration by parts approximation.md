...
$$
the boundary terms can give an [[Asymptotic Methods/Asymptotic Approximation]] under certain circumstances
### Example
...
$$
(this diverges, but that is okay as we can [[Asymptotic Methods/Optimal Truncation]])
### Example
